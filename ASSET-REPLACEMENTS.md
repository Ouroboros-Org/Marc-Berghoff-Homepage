...
| `public/images/proof/klarsolar.webp` | 580×390 | Transparent raster logo with substantial empty padding. It loses definition when enlarged and may look misaligned beside other marks. | Obtain an approved SVG or tightly cropped transparent PNG. Confirm permission and current brand treatment. |
| `public/images/proof/giftagoods.webp` | 447×447 | Transparent raster mark; acceptable in a small logo lock-up. | Obtain an approved SVG where possible and confirm permission. Do not recolour the mark. |
| `public/images/proof/leipziger-apotheke.webp` | 165×105 | Very small raster logo; unsuitable for retina presentation above about 80 CSS pixels. | **BLOCKER if prominently displayed:** obtain SVG/high-resolution artwork or render the attribution as text only. Confirm permission. |
