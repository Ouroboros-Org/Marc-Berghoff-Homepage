...
| --- | --- | --- | --- |
| Bastian A. / Klarsolar testimonial | D1 slide 14 | **Approval needed** | The slide itself contains an internal note questioning approval. Do not publish the quote or identify the speaker until written sign-off is on file. |
