  ...
  return (
    <div className={pageStyles.page} lang="en">
      ...
      <ServiceHero
        ...
        lead="Work with me on your people, leadership and organisation. We can understand an unclear issue, work through a decision or agree ongoing CPO support."
        aside={{
      ...
      <section className={pageStyles.section} aria-labelledby="service-options">
        <div className={pageStyles.container}>
          <div className={`${pageStyles.sectionHeading} ${pageStyles.centered}`}>
            ...
            <p className={pageStyles.intro}>You can start with any engagement. Choose focused help for a particular question or ongoing support for your people and organisation.</p>
          </div>
      ...
      <section className={pageStyles.sectionTint} aria-labelledby="service-methods">
        <div className={pageStyles.container}>
          <div className={`${pageStyles.sectionHeading} ${pageStyles.centered}`}>
            ...
            <p className={pageStyles.intro}>We choose the methods that help your team decide and act. They sit inside the agreed scope.</p>
          </div>
